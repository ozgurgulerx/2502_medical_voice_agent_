...
class ConversationSystem:
    ...
    async def run(self):
        ...
        async with websockets.connect(self.url) as ws:
            ...
            # Immediately start with a greeting
            await self.send_message(ws, "This is MedAssist, a medical call service. How may I assist you with your healthcare needs today?")
