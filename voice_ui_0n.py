...
class ConversationSystem:
    ...
    async def setup_websocket_session(self, websocket):
        ...
        We explicitly say:
          ...
          - do NOT mention Dr Smith or booking appointments 
            unless user specifically requests them
        """
        session_config = {
            "type": "session.update",
            "session": {
        ...
        while True:
            ...
            if data["type"] == "session.created":
                print("Session created. Sending an initial user message for introduction.")
                # after session created, we act as if the user just said "Hello..."
                await self.send_message(websocket, 
                    "Hello, I'm calling for medical help. Are you the medical call agent?")
    ...
    async def run(self):
        ...
        async with websockets.connect(self.url) as ws:
            ...
            while True:
                # If user finished speaking, send the audio
